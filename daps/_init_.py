...
if not BLACKLIST_CHAT:
    BLACKLIST_CHAT = [-1001531612874, -1001531612874, -1001531612874]
...
# Support
GROUP = os.environ.get("GROUP", "privatedap")
CHANNEL = os.environ.get("CHANNEL", "bombleebas")
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/dapsya/userbot.git")
...
ALIVE_LOGO = (os.environ.get("ALIVE_LOGO")
              or "https://telegra.ph/file/798bfa928284f3c4d90ae.jpg")
...
ch = str(b64decode("QGJvbWJsZWViYXM="))[2:13]
gc = str(b64decode("QHByaXZhdGVkYXA="))[2:13]
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"**Daps-userbot v`{BOT_VER}` is back up and running!**\n\n"
        f"**Telethon:** `{vsc}`\n"
...
with bot:
    try:
        ...
        logoyins = random.choice(
            [
                "https://telegra.ph/file/798bfa928284f3c4d90ae.jpg",
                "https://telegra.ph/file/798bfa928284f3c4d90ae.jpg",
                "https://telegra.ph/file/798bfa928284f3c4d90ae.jpg",
                "https://telegra.ph/file/798bfa928284f3c4d90ae.jpg",
            ]
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                text = f"**✨ ᴅᴀᴘs ᴜsᴇʀʙᴏʏ ɪɴʟɪɴᴇ ᴍᴇɴᴜ ✨**\n\n⍟ **ʙᴀsᴇ ᴏɴ :** {adB.name}\n⍟ **ᴅᴇᴘʟᴏʏ :** •[{HOSTED_ON}]•\n⍟ **ᴏᴡɴᴇʀ** {user.first_name}\n⍟ **ᴊᴜᴍʟᴀʜ :** {len(dugmeler)} **Modules**"
                await event.edit(
                    text,
                    file=logoyins,
                    buttons=buttons,
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    ...
                    thumb=InputWebDocument(
                        ...
                        "image/jpeg",
                        []),
                    text="**Daps-userbot**\n➖➖➖➖➖➖➖➖➖➖\n✧  **ʀᴇᴘᴏ :** [daps](https://t.me/itsdaps)\n㋭ **sᴜᴘᴘᴏʀᴛ :** @privatedap\n㋭ **ʀᴇᴘᴏsɪᴛᴏʀʏ :** [Daps_userbot](https://github.com/dapsya/userbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "ɢʀᴏᴜᴘ",
                ...
                result = builder.article(
                    title="String",
                    description="string daps - Userbot",
                    url="https://t.me/privatedap",
                    thumb=InputWebDocument(
                        logoyins,
                        0,
...
""")
        ...
        LOGS.info(
            f"KALO BOT LU NGECRASH, KLIK SAVE YANG DI POJOK KANAN BAWAH DAN KIRIM KE @privatedap » TAG @itsdaps ATAU ADMIN LAINNYA » Info By: Daps-userbot {BOT_VER}")
