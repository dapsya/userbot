...
REPOLINK = str(
    UPSTREAM_REPO_URL) if UPSTREAM_REPO_URL else "https://github.com/UserbotMaps/Hiroshi-Userbot"
# ============================================
...
@hiro_cmd(pattern="shutdown$")
async def killdabot(event):
    """ For .shutdown command, shut the bot down."""
    await edit_or_reply(event, "`Mematikan Hiroshi-Userbot....`")
...
@hiro_cmd(pattern="restart$")
async def killdabot(event):
    await edit_or_reply(event, "`Restarting Hiroshi-Userbot...`")
...
@hiro_cmd(pattern="repo$")
async def repo_is_here(wannasee):
    """ For .repo command, just returns the repo URL. """
    await edit_or_reply(wannasee,
                        "**🔥ʜɪʀᴏsʜɪ-ᴜsᴇʀʙᴏᴛ🔥** \n"
                        "━━━━━━━━━━━━━━━━━━━━━━\n"
                        "➣ **Repo Userbot :** [ɢɪᴛʜᴜʙ](https://github.com/UserbotMaps/Hiroshi-Userbot)\n"
                        "➣ **Owner Bot :** [ʜɪʀᴏsʜɪ ɢᴇɴᴇʀᴀᴛᴏʀ](t.me/Bisubiarenak)\n"
                        "━━━━━━━━━━━━━━━━━━━━━━\n"
                        "➣ **Support :** [sᴜᴘᴘᴏʀᴛ](https://t.me/hiroshisupport)\n"
                        "➣ **Channel :** [ᴄʜᴀɴɴᴇʟ](https://t.me/hiroshimabes)\n"
                        "━━━━━━━━━━━━━━━━━━━━━━\n"
                        )


@hiro_cmd(pattern="string$")
async def repo_is_here(wannasee):
    """For .repo command, just returns the repo URL."""
    await edit_or_reply(wannasee,
...
CMD_HELP.update({
    ...
    \n↳ : `{cmd}sleep`\
    \n  •  **Function : Biarkan Hiroshi-Userbot tidur selama beberapa detik.",
    "shutdown": f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}shutdown`\
    \n↳ : Mematikan bot",
    "repo": f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}repo`\
    \n↳ : Menampilan link Repository Hiroshi-Userbot.",
    "string": f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}string`\
    \n↳: Menampilkan link String Hiroshi-Userbot",
